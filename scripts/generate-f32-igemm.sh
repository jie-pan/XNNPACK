...
tools/xngen src/f32-igemm/wasmsimd-splat.c.in -D MR=1 -D NR=16 -D X86=0 -D ACTIVATION=RELU   -o src/f32-igemm/gen/1x16-relu-wasmsimd-splat.c
...
tools/xngen src/f32-igemm/wasmsimd-splat.c.in -D MR=1 -D NR=16 -D X86=0 -D ACTIVATION=LINEAR -o src/f32-igemm/gen/1x16-wasmsimd-splat.c
...
tools/xngen src/f32-igemm/wasmsimd-splat.c.in -D MR=4 -D NR=16 -D X86=0 -D ACTIVATION=LINEAR -o src/f32-igemm/gen/4x16-wasmsimd-splat.c
...
tools/xngen src/f32-igemm/wasmsimd-splat.c.in -D MR=1 -D NR=16 -D X86=1 -D ACTIVATION=MINMAX -o src/f32-igemm/gen/1x16-minmax-wasmsimd-x86-splat.c
