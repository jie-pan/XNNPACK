...
tools/xngen src/f32-gemm/wasmsimd-splat.c.in -D MR=1 -D NR=16 -D X86=0 -D INC=0 -D ACTIVATION=RELU   -o src/f32-gemm/gen/1x16-relu-wasmsimd-splat.c
...
tools/xngen src/f32-gemm/wasmsimd-splat.c.in -D MR=4 -D NR=16 -D X86=0 -D INC=0 -D ACTIVATION=RELU   -o src/f32-gemm/gen/4x16-relu-wasmsimd-splat.c
...
tools/xngen src/f32-gemm/wasmsimd-loadsplat.c.in -D MR=4 -D NR=8 -D X86=0 -D INC=0 -D ACTIVATION=RELU   -o src/f32-gemm/gen/4x8-relu-wasmsimd-loadsplat.c
tools/xngen src/f32-gemm/wasmsimd-loadsplat.c.in -D MR=4 -D NR=16 -D X86=0 -D INC=0 -D ACTIVATION=RELU   -o src/f32-gemm/gen/4x16-relu-wasmsimd-loadsplat.c
...
tools/xngen src/f32-gemm/wasmsimd-splat.c.in -D MR=1 -D NR=16 -D X86=0 -D INC=0 -D ACTIVATION=LINEAR -o src/f32-gemm/gen/1x16-wasmsimd-splat.c
...
tools/xngen src/f32-gemm/wasmsimd-loadsplat.c.in -D MR=4 -D NR=8 -D X86=1 -D INC=0 -D ACTIVATION=LINEAR -o src/f32-gemm/gen/4x8-wasmsimd-x86-loadsplat.c
tools/xngen src/f32-gemm/wasmsimd-loadsplat.c.in -D MR=4 -D NR=16 -D X86=1 -D INC=0 -D ACTIVATION=LINEAR -o src/f32-gemm/gen/4x16-wasmsimd-x86-loadsplat.c
...
#panjie
tools/xngen src/f32-gemm/wasmsimd-splat.c.in -D MR=1 -D NR=16 -D X86=1 -D INC=0 -D ACTIVATION=MINMAX -o src/f32-gemm/gen/1x16-minmax-wasmsimd-x86-splat.c
