...
void xnn_f32_gemm_minmax_ukernel_4x16__wasmsimd_x86_loadsplat(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const union xnn_f32_minmax_params params[restrict XNN_MIN_ELEMENTS(1)])
{
  ...
  do {
    ...
    vacc0x89AB = wasm_v128_bitselect(vmin, vacc0x89AB, wasm_f32x4_lt(vacc0x89AB, vmin));
    vacc1x89AB = wasm_v128_bitselect(vmin, vacc1x89AB, wasm_f32x4_lt(vacc1x89AB, vmin));
    vacc2x89AB = wasm_v128_bitselect(vmin, vacc2x89AB, wasm_f32x4_lt(vacc2x89AB, vmin));
    vacc3x89AB = wasm_v128_bitselect(vmin, vacc3x89AB, wasm_f32x4_lt(vacc3x89AB, vmin));
    vacc0xCDEF = wasm_v128_bitselect(vmin, vacc0xCDEF, wasm_f32x4_lt(vacc0xCDEF, vmin));
    vacc1xCDEF = wasm_v128_bitselect(vmin, vacc1xCDEF, wasm_f32x4_lt(vacc1xCDEF, vmin));
    vacc2xCDEF = wasm_v128_bitselect(vmin, vacc2xCDEF, wasm_f32x4_lt(vacc2xCDEF, vmin));
    vacc3xCDEF = wasm_v128_bitselect(vmin, vacc3xCDEF, wasm_f32x4_lt(vacc3xCDEF, vmin));
    ...
    vacc0x89AB = wasm_v128_bitselect(vacc0x89AB, vmax, wasm_f32x4_le(vacc0x89AB, vmax));
    vacc1x89AB = wasm_v128_bitselect(vacc1x89AB, vmax, wasm_f32x4_le(vacc1x89AB, vmax));
    vacc2x89AB = wasm_v128_bitselect(vacc2x89AB, vmax, wasm_f32x4_le(vacc2x89AB, vmax));
    vacc3x89AB = wasm_v128_bitselect(vacc3x89AB, vmax, wasm_f32x4_le(vacc3x89AB, vmax));
    vacc0xCDEF = wasm_v128_bitselect(vacc0xCDEF, vmax, wasm_f32x4_le(vacc0xCDEF, vmax));
    vacc1xCDEF = wasm_v128_bitselect(vacc1xCDEF, vmax, wasm_f32x4_le(vacc1xCDEF, vmax));
    vacc2xCDEF = wasm_v128_bitselect(vacc2xCDEF, vmax, wasm_f32x4_le(vacc2xCDEF, vmax));
    vacc3xCDEF = wasm_v128_bitselect(vacc3xCDEF, vmax, wasm_f32x4_le(vacc3xCDEF, vmax));
